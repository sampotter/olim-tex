...
eikonal equation (see appendix \ref{sec:minimum-action-integral}). The
...
Following this, we describe our \emph{bottom-up} algorithm in subsection
...
\subsection{The \emph{bottom-up} and \emph{top-down}}
  algorithms}\label{ssec:top-down-and-bottom-up}
